...
on a.emp_no = b.emp_no and a.emp_no = c.emp_no and a.emp_no = e.emp_no and d.dept_no = e.dept_no
where b.to_date = '9999-01-01' and c.to_date = '9999-01-01' and e.to_date = '9999-01-01'
order by a.first_name asc;
...
from employees a join titles b join salaries c on a.emp_no = b.emp_no and a.emp_no = c.emp_no
where b.title = 'engineer' and c.salary >= 40000 and b.to_date = '9999-01-01' and c.to_date = '9999-01-01'
...
from employees a join salaries b join dept_emp c join departments d on a.emp_no = b.emp_no and a.emp_no = c.emp_no and c.dept_no = d.dept_no
where b.to_date = '9999-01-01' and c.to_date = '9999-01-01'
